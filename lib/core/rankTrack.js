...
const {createUuleGPS}       = require('../utils/uule'); // kept import to match original
...
function buildGbpProfileUrl(config = {}) {
  const directUrl = config.profileUrl || config.profile_url;
  if (directUrl) return directUrl;

  const placeId = config.placeId || config.place_id;
  if (placeId) {
...
async function getProfileRank_v1({ runId, pointId, keyword, origin, config }) {
  ...
  let username, password, endpoint, ip;
  try {
    ({ username, password, endpoint, ip } = await getSoaxProxyAuth(soaxConfig));
  } catch (error) {
    console.error('→ [RANK] Failed to obtain SOAX proxy for getProfileRank_v1:', error.message);
    await quit('soax_failed'); // Cancel the run
    return; // Exit the function after calling quit
  }
...
async function getMapsRank({ runId, pointId, keyword, origin, config }) {
  // console.log(`[getMapsRank]`, config);
  // --- START TIMING HERE ---
  ...
  try {
    ...
    console.error('→ [RANK] Failed to obtain SOAX proxy for getMapsRank:', error.message);
    return await quit('soax_failed'); // Cancel the run
  }
  ...
  try {
   ...
   const screenshotFile = 'test';
    ...
    const urlWithUule = `${url}&uule=${uuleParam}&uul=${uuleParam}&uugc=1`;
    console.log(urlWithUule);

    note('urlWithUule', urlWithUule.slice(0, 100));

    const uule = createUuleGPS(latParam, lngParam)
    const requestedUrl = urlWithUule;
    const currentUrl = urlWithUule;
    const res = await fetch(urlWithUule, {
      headers: {
...
async function getProfileRank({ runId, pointId, keyword, origin, config }) {
  ...
  let soaxProxy;
  try {
    soaxProxy = await getSoaxProxyAuth(soaxConfig);
  } catch (error) {
    console.error('→ [RANK] Failed to obtain SOAX proxy for getProfileRank:', error.message);
    return await quit('soax_failed'); // Cancel the run
  }
  ...
  async function quit(finalReason) {
    ...
    // Throw a specific error that includes the necessary failure reason.
    console.error(`❌ RANK_ACQUISITION_FAILED: ${reason} (Run ${runId}, Point ${pointId})`, finalReason);
    throw new Error(`RANK_ACQUISITION_FAILED: ${reason} (Run: ${runId}, Point: ${pointId})`, errorDetails);
  ...
  note(`[SOAX] city: ${soaxProxy.city}`)


  try {
    async function fetchViaSoax(soaxProxy, url, opts = {}) {
      const { username, password, endpoint, city } = soaxProxy;
      const timeoutMs = opts.timeoutMs ?? 15000;
      const retries = opts.retries ?? 1;
      const uule = opts.uule;
    ...
    function buildFullPbUrl(query, latitude, longitude) {
      ...
      // All the pb flags (keep these - they work!)
      const constantPbFlags_Part1 = '!4m9!1m3!1d';
      const constantPbFlags_Part2 = '!2m0!3m2!1i1611!2i1100!4f';
      const constantPbFlags_Part3 = '!7i20!10b1!12m25!1m5!18b1!30b1!31m1!1b1!34e1!2m4!5m1!6e2!20e3!39b1!10b1!12b1!13b1!16b1!17m1!3e1!20m3!5e2!6b1!14b1!46m1!1b0!96b1!99b1!19m4!2m3!1i360!2i120!4i8!20m65!2m2!1i203!2i100!3m2!2i4!5b1!6m6!1m2!1i86!2i86!1m2!1i408!2i240!7m33!1m3!1e1!2b0!3e3!1m3!1e2!2b1!3e2!1m3!1e2!2b0!3e3!1m3!1e8!2b0!3e3!1m3!1e10!2b0!3e3!1m3!1e10!2b1!3e2!1m3!1e10!2b0!3e4!1m3!1e9!2b1!3e2!2b1!9b0!15m16!1m7!1m2!1m1!1e2!2m2!1i195!2i195!3i20!1m7!1m2!1m1!1e2!2m2!1i195!2i195!3i20!24m110!1m31!13m9!2b1!3b1!4b1!6i1!8b1!9b1!14b1!20b1!25b1!18m20!3b1!4b1!5b1!6b1!9b1!12b1!13b1!14b1!17b1!20b1!21b1!22b1!27m1!1b0!28b0!32b1!33m1!1b1!34b1!36e2!10m1!8e3!11m1!3e1!14m1!3b0!17b1!20m2!1e3!1e6!24b1!25b1!26b1!27b1!29b1!30m1!2b1!36b1!37b1!39m3!2m2!2i1!3i1!43b1!52b1!54m1!1b1!55b1!56m1!1b1!61m2!1m1!1e1!65m5!3m4!1m3!1m2!1i224!2i298!72m22!1m8!2b1!5b1!7b1!12m4!1b1!2b1!4m1!1e1!4b1!8m10!1m6!4m1!1e1!4m1!1e3!4m1!1e4!3sother_user_google_review_posts__and__hotel_and_vr_partner_review_posts!6m1!1e1!9b1!89b1!98m3!1b1!2b1!3b1!103b1!113b1!114m3!1b1!2m1!1b1!117b1!122m1!1b1!126b1!127b1!26m4!2m3!1i80!2i92!4i8!30m28!1m6!1m2!1i0!2i0!2m2!1i530!2i1100!1m6!1m2!1i1561!2i0!2m2!1i1611!2i1100!1m6!1m2!1i0!2i0!2m2!1i1611!2i20!1m6!1m2!1i0!2i1080!2m2!1i1611!2i1100!34m19!2b1!3b1!4b1!6b1!8m6!1b1!3b1!4b1!5b1!6b1!7b1!9b1!12b1!14b1!20b1!23b1!25b1!26b1!31b1!37m1!1e81!42b1!47m0!49m10!3b1!6m2!1b1!2b1!7m2!1e3!2b1!8b1!9b1!10e2!50m4!2e2!3m2!1b1!3b1!67m5!7b1!10b1!14b1!15m1!1b0!69i753';
      
      // REMOVED: authuser, gs_l, tch, ech, psi, oq
      const url = `https://www.google.com/search?tbm=map&hl=en&gl=us&pb=${constantPbFlags_Part1}${strRadius}!2d${strLon}!3d${strLat}${constantPbFlags_Part2}${strZoom}${constantPbFlags_Part3}&q=${encodedQuery}`;
      
      return url;
    }

    function buildOptimalPbUrl(query, latitude, longitude, radiusMeters = 5000) {
      const zoomLevel = 14;
      
      // Add flags to request full business data
      const pb = `!4m9!1m3!1d${radiusMeters}!2d${longitude}!3d${latitude}!3m2!1i800!2i600!4f${zoomLevel}!7i20!10b1!12m8!1m3!18b1!19b1!20b1!2m2!1i203!2i100!3m1!2i4`;
      
      return `https://www.google.com/search?tbm=map&hl=en&gl=us&pb=${pb}&q=${encodeURIComponent(query)}`;
    }    

    const uule = createUuleGPS(latParam, lngParam)
    const url = buildFullPbUrl(keyword, latParam, lngParam);
    const urlWithUule = `${url}&uule=${uule}&uul=${uule}&uugc=1`;

    note('→ → [RANKING] urlWithUule', urlWithUule.slice(0, 100));
    const requestedUrl = urlWithUule;
    const currentUrl = urlWithUule;

    const res = await fetchViaSoax(soaxProxy, urlWithUule, { timeoutMs: 20000, retries: 2, uule: uule });
...
async function getGbpProfile({ runId, pointId, config, profileUrl }) {
  const startTime = Date.now();
  const requestedUrl = profileUrl || buildGbpProfileUrl(config || {});
  const safeRunId = runId ?? 0;
  const safePointId = pointId ?? 'gbp';

  if (!requestedUrl) {
    note('→ [GBP] Missing profile identifier; cannot fetch.');
    return {
      runId: safeRunId,
      pointId,
      reason: 'missing_profile_identifier',
      durationMs: 0,
      durationSeconds: 0,
      rawHtml: null,
      requestedUrl: null,
      ...
      device: 'HTTP',
      proxy: 'none',
      business: config?.business_name || null
    };
  }

  note(`→ [GBP] Fetching profile: ${requestedUrl}`);
  ...
  try {
    ...
    currentUrl = res.url || requestedUrl;
    rawHtml = await res.text();

    if (res.ok && rawHtml) {
      reason = 'HTML_acquired';
      await saveHtml(safeRunId, safePointId, 'GBP_PROFILE', rawHtml);
    } else if (res.ok) {
      reason = 'HTML_not_found';
    } else {
    ...
    reason = 'fetch_failed';
    note(`→ [GBP] Fetch failed: ${err.message}`);
  }
...
module.exports = {getMapsRank, getProfileRank_SoaxApi};
