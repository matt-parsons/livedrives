...
// const { parseRankFromString } = require('../google/counters');
...
// async function findProfileRank(page, businessName) {
//     const rawHtml = await page.content();
//     const parseResult = parseRankFromString(rawHtml, businessName);
