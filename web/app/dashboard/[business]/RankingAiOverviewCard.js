...
export default function RankingAiOverviewCard({ businessId = null, businessName = '', isReady = false }) {
      ...
      <div className={`ai-overview-card__body${loading ? ' ai-overview-card__body--loading' : ''}`}>
        {displayedText ? (
          ...
          <p className="ai-overview-card__placeholder">
            {loading ? 'Generating a quick readout of your ranking reports…' : 'Hang tight. We are loading your snapshot now.'}
          </p>
        )}
      </div>
